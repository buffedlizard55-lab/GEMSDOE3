...
<details class="file-details"><summary>Support curve (sgmc-target, halo 1, tuning fold): the proxy peaks well inside the 8% cap</summary><div class="table-scroll"><table><thead><tr><th>Floor</th><th>Support</th><th>gap</th><th>all</th></tr></thead><tbody>{curve}</tbody></table></div></details></section>'''
    return f'''<section class="section-block" id="gapfinder"><div class="section-header"><div><div class="eyebrow">CURRENT EXPERIMENT · {esc(gx['name']).upper()}</div><h2>Gapfinder: learn where the supplied labels are incomplete.</h2></div><a class="text-link" href="data/gapfinder-experiment.json">Full report JSON ↗</a></div>
